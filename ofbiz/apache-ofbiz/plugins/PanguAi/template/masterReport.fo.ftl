...
<fo:table table-layout="fixed"  border="1pt solid" padding="5pt" width="66cm" font-size="14pt" border-width=".1mm" >
        <fo:table-body>
            <fo:table-row >
                        <fo:table-cell background-color="rgb(126, 187, 240)" border="2pt solid black" width="4cm" text-align="center" font-weight="bold"  padding="4pt" number-columns-spanned="7"><fo:block padding="4pt" ></fo:block></fo:table-cell>
            ...
            <fo:table-row >
                        <fo:table-cell background-color="rgb(126, 187, 240)" border="1pt solid black"  text-align="center" font-weight="bold"  padding="4pt"><fo:block padding="4pt" width="6cm">RAMS Num</fo:block></fo:table-cell>
                        ...
                        <fo:table-cell background-color="rgb(126, 187, 240)" border="1pt solid black" font-weight="bold" padding="4pt"><fo:block padding="4pt">Time period for observation:</fo:block></fo:table-cell>
                        ...
                        <fo:table-cell background-color="rgb(126, 187, 240)" border="1pt solid black" font-weight="bold" padding="4pt"><fo:block padding="4pt">Best Estimated of failure rate:</fo:block></fo:table-cell>
                        <fo:table-cell background-color="rgb(126, 187, 240)" border="1pt solid black" font-weight="bold" padding="4pt"><fo:block padding="4pt">Equiv MTBFs:</fo:block></fo:table-cell>
                        <fo:table-cell background-color="rgb(126, 187, 240)" border="1pt solid black" font-weight="bold" padding="4pt"><fo:block padding="4pt">90% confidence interval - upper bound:</fo:block></fo:table-cell>
                        <fo:table-cell background-color="rgb(126, 187, 240)" border="1pt solid black" font-weight="bold" padding="4pt"><fo:block padding="4pt">Equiv MTBFs:</fo:block></fo:table-cell>
                        <fo:table-cell background-color="rgb(126, 187, 240)" border="1pt solid black" font-weight="bold" padding="4pt"><fo:block padding="4pt">90% confidence interval - lower bound:</fo:block></fo:table-cell>
                         <fo:table-cell background-color="rgb(126, 187, 240)" border="1pt solid black" font-weight="bold" padding="4pt"><fo:block padding="4pt">Equiv MTBFs:</fo:block></fo:table-cell>
                        <fo:table-cell background-color="rgb(126, 187, 240)" border="1pt solid black" font-weight="bold" padding="4pt"><fo:block padding="4pt">Repair Time:</fo:block></fo:table-cell>
                        <fo:table-cell background-color="rgb(126, 187, 240)" border="1pt solid black" font-weight="bold" padding="4pt"><fo:block padding="4pt">Planned maintenance time:</fo:block></fo:table-cell>
                        ...
                        <fo:table-cell background-color="rgb(126, 187, 240)" border="1pt solid black" font-weight="bold" padding="4pt"><fo:block padding="4pt">Time period:</fo:block></fo:table-cell>
            ...
            <#list combinedRamsData as ramsData>
                <fo:table-row >
                            <fo:table-cell background-color="rgb(170, 185, 198)" border="1pt solid black" text-align="center" font-weight="bold"  padding="2pt"><fo:block padding="4pt">${ramsData.header.ramsNo}</fo:block></fo:table-cell>
