    ...
    <fo:table-body>
        ...
        <fo:table-row>
            <fo:table-cell border="1pt solid black" padding="4pt">
                <fo:block number-columns-spanned="2" font-weight="bold" text-align="center">
        ...
        <fo:table-row>
            <fo:table-cell border="1pt solid black" padding="4pt">
                <fo:block>${uiLabelMap.OrderDateOrdered}</fo:block>
            </fo:table-cell>
            <fo:table-cell border="1pt solid black" padding="4pt">
        ...
        <fo:table-row>
            <fo:table-cell border="1pt solid black" padding="4pt">
                <fo:block>${uiLabelMap.OrderOrder} ${uiLabelMap.CommonNbr}</fo:block>
            </fo:table-cell>
            <fo:table-cell border="1pt solid black" padding="4pt">
        ...
        <fo:table-row>
            <fo:table-cell border="1pt solid black" padding="4pt">
                <fo:block>${uiLabelMap.OrderCurrentStatus}</fo:block>
            </fo:table-cell>
            <fo:table-cell border="1pt solid black" padding="4pt">
        ...
        <!-- Cancel Back Order Date Row (Conditional) -->
        <#if orderItem.cancelBackOrderDate??>
            <fo:table-row>
                <fo:table-cell border="1pt solid black" padding="4pt">
                    <fo:block>${uiLabelMap.FormFieldTitle_cancelBackOrderDate}</fo:block>
                </fo:table-cell>
                <fo:table-cell border="1pt solid black" padding="4pt">
                    <#assign dateFormat = Static["java.text.DateFormat"].LONG>
