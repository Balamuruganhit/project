...
<#if productionRunId?has_content>
            <fo:list-block provisional-distance-between-starts="40mm">
                ...
                <fo:list-item>
                    ...
                    <fo:list-item-body start-indent="body-start()"><fo:block><fo:inline font-size="14" font-weight="bold" space-end="5mm">${productionRunData.productId!}</fo:inline><#if productionRunComponentData.brandName??> ${productionRunComponentData.brandName}</#if></fo:block></fo:list-item-body>
                </fo:list-item
            </fo:list-block>
